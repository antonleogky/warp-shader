    ...
    <>
      ...
      >
        <ScrubField
          ...
          onChange={(v) => { params.streakCount = v; }}
        />
        <ScrubField
          label="Thickness"
        ...
        <ScrubField
          ...
          onChange={(v) => { params.cornerRadius = v; }}
        />
        <ScrubField
          label="Center void"
          ...
          onChange={(v) => { params.centerVoidRadius = v; }}
        />
      </FieldGroup>
      ...
      <FieldGroup title="Layout" hint="Static spread and random placement of beams.">
        ...
        <ScrubField
          ...
          value={params.seed}
          onChange={(v) => { params.seed = v; }}
        />
        <div className={cn("flex items-center justify-between gap-3", PANEL_SETTING_PY)}>
